...
public class AdMobAPI {
    ...
    public int mInterstitialAd_Status=0;

    public static final int mInterstitialAd_Status_Loaded=1;
    public static final int mInterstitialAd_Status_Failed=2;
            ...
            InterstitialAd.load(mContext, mContext.getString(R.string.AdMob_Int_Id1), adRequest,
                    new InterstitialAdLoadCallback() {
                        ...
                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                            ...
                            mInterstitialAd_Status=mInterstitialAd_Status_Loaded;
                        ...
                        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                            ...
                            mInterstitialAd = null;
                            mInterstitialAd_Status=mInterstitialAd_Status_Failed;
                        }
                    });
